...
public class KafkaConfig {
	...
	/*
	 * @Bean public ConsumerFactory<String, Order> orderConsumerFactory(){
	 * 
	 * Map<String, Object> config = new HashMap<>();
	 * config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,
	 * "ec2-18-207-140-130.compute-1.amazonaws.com:9092");
	 ...
	 * 
	 * @Bean public ProducerFactory<String, Order> failureProducerFactory() {
	 * 
	 * Map<String, Object> config = new HashMap<>();
	 * 
	 ...
	 * 
	 * @Bean public KafkaTemplate<String, Order> failureKafkaTemplate(){
	 * 
	 * return new KafkaTemplate<String, Order>(failureProducerFactory()); }
	 * 
	 * 
	 * @Bean public ProducerFactory<String, OrderSucceedDto>
	 * successProducerFactory() {
	 * 
	 * Map<String, Object> config = new HashMap<>();
	 * 
	 * config.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG,
	 ...
	 * return new DefaultKafkaProducerFactory<>(config); }
	 * 
	 * @Bean public KafkaTemplate<String, OrderSucceedDto> successKafkaTemplate(){
	 * 
